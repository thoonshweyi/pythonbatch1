...
try:
     ...
     # Create Document
     # for data in datas:
     #      doc_ref = db.collection(collection_name).document() #  auto
     #      batch.set(doc_ref,{"username":data[0],"email":data[1],"createdAt":firestore.SERVER_TIMESTAMP})
     ...
     print(f"{len(datas)} documents inserted into Collection {collection_name} is ready in Firestore!")
